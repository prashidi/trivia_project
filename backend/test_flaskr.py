...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_add_question_invalid_question(self):
        res = self.client().post('/questions', json={'answer': 'test', 'category': 1, 'difficulty': 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 400)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Bad request')
    ...
    def test_add_question_invalid_answer(self):
        res = self.client().post('/questions', json={'question': 'test', 'category': 1, 'difficulty': 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 400)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Bad request')
    ...
    def test_add_question_invalid_category(self):
        res = self.client().post('/questions', json={'question': 'test', 'answer': 'test', 'difficulty': 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 400)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Bad request')
    ...
    def test_add_question_invalid_difficulty(self):
        res = self.client().post('/questions', json={'question': 'test', 'answer': 'test', 'category': 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 400)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Bad request')
    ...
    def test_search_questions_per_page(self):
        res = self.client().post('/search', json={'searchTerm': 'test', 'page': 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertTrue(data['questions'])
